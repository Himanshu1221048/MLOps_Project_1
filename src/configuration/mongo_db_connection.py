...
"""
certifi gives your Python application a trusted list of secure "internet authorities" — so it can safely connect to HTTPS (or tls://) endpoints.
You’re using TLS encryption (just like HTTPS) to securely transmit data between your code and the MongoDB cloud server.
"""
ca = certifi.where()
